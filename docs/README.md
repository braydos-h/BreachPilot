...
- [Runtime Flows](runtime-flows.md): how recon, task execution, exploitation, TUI, and MCP flows move through the code.
- [Module Guide](module-guide.md): responsibilities of the top-level modules, `tools/`, `tui/`, and tests.
...
- `python -m tui`: Textual dashboard over the backend services.
