...
6. [Graph Explorer Routes](#graph-explorer-routes)
   - [Graph](#get-graphrunsrun_id)
   - [Summary](#get-graphrunsrun_idsummary)
   - [Conflicts](#get-graphrunsrun_idconflicts)
   - [Node](#get-graphrunsrun_idnodesnode_id)
   - [Neighbors](#get-graphrunsrun_idnodesnode_idneighbors)
   - [Paths](#get-graphrunsrun_idpaths)
...
9. [Event Routes](#event-routes)
   ...
   - [WebSocket Stream](#ws-wsv1runsrun_id)
