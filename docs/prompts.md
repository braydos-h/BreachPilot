...
| 6 | Initial user message | `tools/exploit_agent/loop.py:698` | First-turn target/permission briefing |
...
`tools/exploit_agent/loop.py:674` calls `build_exploit_system_prompt` with
