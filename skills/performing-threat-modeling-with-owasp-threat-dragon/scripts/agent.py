...
STRIDE_MITIGATIONS = {
    ...
    "Information Disclosure": ["Encrypt data at rest and in transit", "Implement least-privilege access"],
    "Denial of Service": ["Implement rate limiting", "Use auto-scaling and circuit breakers"],
    "Elevation of Privilege": ["Enforce RBAC and least privilege", "Validate authorization on every request"],
}
