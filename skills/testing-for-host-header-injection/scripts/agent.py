...
class HostHeaderInjectionAgent:
    ...
    def _request(self, method, path, headers=None, data=None, timeout=10, allow_redirects=False):
        ...
        try:
            return requests.request(
                method, url, headers=headers, data=data, timeout=timeout, allow_redirects=allow_redirects
            )
    ...
    def test_cache_poisoning(self, path="/"):
        ...
        resp1 = self._request("GET", f"{path}{cache_buster}", headers={"X-Forwarded-Host": evil_host})
