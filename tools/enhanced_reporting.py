...
class EnhancedReportGenerator:
    ...
    def generate_full_report(
        ...
        *,
        ...
        report_data = self._build_report_data(campaign_result)
    ...
    def _build_report_data(self, campaign_result: dict[str, Any]) -> dict[str, Any]:
    ...
    def _estimate_cvss(self, exploit_name: str, services: list[dict]) -> CVSSScore:
        """Estimate CVSS score based on exploit type."""
